...
public class Meal {
	...
	/**
	 * @param dish_name
	 * @param ingredients_names
	 * @param ingredient_qty
	 * @param price
	 * @param special_price
	 * @param points
	 */
	public Meal(String dish_name, ArrayList<String> ingredients_names, ArrayList<Float> ingredient_qty, double price,
			double special_price, int points) {
		super();
		this.dish_name = dish_name;
	...
	public String toString() {
		return "Meal [dish_name=" + dish_name + ", ingredients_names=" + ingredients_names + ", ingredient_qty="
				+ ingredient_qty + ", price=" + price + ", special_price=" + special_price + ", points=" + points + "]";
	}
	/**
	 * Getters and Setters
	 * @return
